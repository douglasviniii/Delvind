  ...
  useEffect(() => {
    ...
    const fetchReceipt = async () => {
      ...
      if (receiptSnap.exists()) {
        ...
        if (user && receiptData.clientId !== user.uid) {
            toast({ title: 'Acesso Negado', description: 'Você não tem permissão para ver este recibo.', variant: 'destructive'});
    ...
    <>
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 print:hidden">
        <div className="flex items-center gap-4">
            ...
            <p className="text-muted-foreground">Visualize e imprima seu comprovante de pagamento.</p>
            </div>
        </div>
      ...
      <div className="bg-background rounded-lg shadow-lg md:p-8 p-4 max-w-4xl mx-auto printable-area">
        {/* Header */}
          ...
          <div className="text-center my-12">
            ...
            <p className="text-muted-foreground">Recebemos seu pagamento com sucesso.</p>
          </div>
