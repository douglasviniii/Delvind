                    ...
                    <CardContent className='space-y-6'>
                        {groupedTasks.length > 0 ? groupedTasks.map(([date, tasks], index) => {
                            ...
                            <div key={date}>
                                ...
                                {tasks.map(task => (
                                     <Card key={task.id} className={cn("transition-all", task.isAppointment && 'bg-orange-50 border-orange-200 dark:bg-orange-900/20 dark:border-orange-800', isOverdue && !task.isAppointment && 'border-destructive/50')}>
